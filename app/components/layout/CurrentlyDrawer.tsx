    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="absolute top-6 right-6 bg-transparent border-0 font-body text-[14px] font-medium uppercase tracking-[0.15em] text-text-muted cursor-pointer p-1 transition-colors duration-200 hover:text-accent"
        >
          {LABEL_CLOSE}
        </button>
        ...
        {/* Header */}
        <div>
          <p className="font-body text-[14px] font-medium uppercase tracking-[0.18em] text-accent-deep mb-4">
            {CURRENTLY_TITLE}
          </p>
        ...
        {/* Footer */}
        <p
          className="font-body text-[14px] text-text-muted tracking-[0.05em] leading-relaxed pt-6 mt-auto"
...
function CurrentlyBlock({ item }: { item: CurrentlyItem }) {
  ...
  return (
    ...
    >
      <p className="font-body text-[14px] font-medium uppercase tracking-[0.15em] text-text-muted mb-3">
        {label}
      </p>
      {renderedParagraphs}
    </div>
