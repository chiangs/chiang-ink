...
function ChartLabel({ children }: { children: React.ReactNode }) {
  return (
    <p className="font-body font-medium text-[14px] text-text-muted uppercase tracking-[0.1em] mb-3">
      {children}
    </p>
  );
}
...
function WaffleChart({
  ...
  return (
    <div style={cellStyle}>
      ...
      <p
        className="font-body font-normal text-[14px] text-text-muted"
          ...
          {industryCounts.map(([industry, count]) => {
            ...
            return (
              <div key={industry} className="flex items-center gap-1.5 min-w-0">
                ...
                />
                <span className="font-body font-normal text-[14px] text-text-muted truncate">
                  {industry} {pct}%
                </span>
              </div>
            );
            ...
            <>
              ...
              {hoveredIdx !== null && tooltipData && (
                <div style={tooltipStyle}>
                  <div className="font-body font-normal text-[14px] text-text-primary">
                    {tooltipData.label}
                  </div>
                  <div className="font-body font-normal text-[14px] text-text-muted mt-0.5">
...
function NetworkGraph({
  ...
  return (
    <div style={cellStyle}>
      ...
      <p className="font-body font-normal text-[14px] text-text-muted mb-4">
  ...
  return (
    <div style={cellStyle} className="flex flex-col justify-between h-full">
      ...
      <div className="flex flex-col justify-center flex-1">
        ...
        <span className="font-body font-normal text-[14px] text-text-muted block mt-2">
          {LABEL_MONTHS_TO_MVP}
        </span>
      </div>
    </div>
  ...
  return (
    <div className="bg-surface border-b border-border">
      ...
      >
        ...
        >
          <span className="font-body font-medium text-[14px] text-accent uppercase tracking-[0.15em]">
            {LABEL_WORK_INSIGHTS}
          </span>
          <span className="font-body font-medium text-[14px] text-text-muted">
        ...
        {/* Collapsible body */}
        <div ref={contentRef}>
          <p className="font-body font-normal text-[14px] text-text-muted mt-3 mb-6">
            {subLabel}
          </p>
