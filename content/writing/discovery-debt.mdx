...
<FloatImage
  src="/images/content/discovery.webp"
  alt="Overhead view of a detailed terrain map spread across a wooden desk, illuminated by a single lamp. A planning board covered in annotated sticky notes and arrows sits behind it — the visible work of mapping an unknown landscape before committing to a route."
  caption="REF_001 // MAPPING THE UNKNOWN"
  raw
/>
...
<ArticleImage src="/images/content/convergence.webp" alt="Three beams of light — amber and teal — converging at a single vanishing point inside a dark industrial space. A visual metaphor for distinct disciplines meeting at a common purpose." caption="REF_002 // THREE PERSPECTIVES" raw/>
...
<RiskMatrix
  columnAxisLabel="Stopped at"
  columns={["Scope creep", "Rework", "Tech debt", "Delivery slip", "Pivot risk"]}
  rows={[
    {
      heading: "OKRs only",
      subheading: "Skip everything else",
      cells: [
        { level: "high", label: "High", note: "No problem defined" },
        { level: "high", label: "High", note: "No solution tested" },
        { level: "high", label: "High", note: "Constraints mapped" },
        { level: "high", label: "High", note: "No context for build" },
        { level: "very-high", label: "Very high", note: "Building blind" },
      ],
    },
    {
      heading: "+ Perspectives",
      subheading: "Skip OST + Experiment",
      cells: [
        { level: "medium", label: "Medium", note: "Problem understood" },
        { level: "high", label: "High", note: "Solutions unvalidated" },
        { level: "high", label: "High", note: "Tech still unknown" },
        { level: "high", label: "High", note: "Constraints surfaced" },
        { level: "medium", label: "Medium", note: "Direction is clearer" },
      ],
    },
    {
      heading: "+ OST",
      subheading: "Skip Experiment only",
      cells: [
        { level: "low", label: "Low", note: "Opportunity mapped" },
        { level: "medium", label: "Medium", note: "Solutions not tested" },
        { level: "medium", label: "Medium", note: "Assumptions surfaced" },
        { level: "medium", label: "Medium", note: "Some unknowns remain" },
        { level: "low", label: "Low", note: "Right direction" },
      ],
    },
    {
      heading: "+ Experiment",
      subheading: "Full discovery",
      cells: [
        { level: "eliminated", label: "Eliminated", note: "Validated solution" },
        { level: "eliminated", label: "Eliminated", note: "Built what works" },
        { level: "eliminated", label: "Eliminated", note: "Constraints resolved" },
        { level: "low", label: "Low", note: "Some iteration normal" },
        { level: "eliminated", label: "Eliminated", note: "De-risked backlog" },
      ],
    },
  ]}
  legend={[
    { level: ["high", "very-high"], label: "High / Very high risk" },
    { level: "medium", label: "Medium risk" },
    { level: ["low", "eliminated"], label: "Low / Eliminated" },
  ]}
  caption="Each stage systematically de-risks the delivery. Skipping a stage does not save time — it defers the cost."
/>
...
<ArticleImage src="/images/content/okr-ost.webp" alt="Flow diagram showing the OKR and Opportunity Solution Tree framework. Three research perspectives — Human, Organisational, and Technical — feed into the OST, which maps opportunities through experimentation to a validated backlog and delivery. The Technical perspective is highlighted as the one most often absent from discovery." caption="REF_003 // DISCOVERY FRAMEWORK" raw/>
